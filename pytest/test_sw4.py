...
# assign     OMP_NUM_THREADS
                ...
                if result_file == 'whi.log':
                    import verify_geodynbc
                    success = True
                    verify_geodynbc.whiwriter(pytest_dir)
                elif result_file == 'geodynbc.log':
                    import verify_geodynbc
                    success = verify_geodynbc.verify(pytest_dir, 1e-5)
                elif result_file == 'hdf5.log':
                    import verify_hdf5
                    success = True
