...
#pragma omp simd
 ...
 { 
  ...
  dum2 = a2*(u(1,i-2,j+2,k)-u(1,i-2,j-2,k))+
     a1*(u(1,i-2,j+1,k)-u(1,i-2,j-1,k));
  r1 = r1 +stry(j)*strx(i)*(a1*(c(19,i+1,j,k)*dup1-c(19,i-1,j,k)*dum1)
     +a2*(c(19,i+2,j,k)*dup2-c(19,i-2,j,k)*dum2));
  r2 = r2 +stry(j)*strx(i)*(a1*(c(22,i+1,j,k)*dup1-c(22,i-1,j,k)*dum1)
     +a2*(c(22,i+2,j,k)*dup2-c(22,i-2,j,k)*dum2));
  r3 = r3 +stry(j)*strx(i)*(a1*(c(25,i+1,j,k)*dup1-c(25,i-1,j,k)*dum1)
     +a2*(c(25,i+2,j,k)*dup2-c(25,i-2,j,k)*dum2));
  ...
  dum2 = a2*(u(2,i-2,j+2,k)-u(2,i-2,j-2,k))+
     a1*(u(2,i-2,j+1,k)-u(2,i-2,j-1,k));
  r1 = r1 +stry(j)*strx(i)*(a1*(c(20,i+1,j,k)*dup1-c(20,i-1,j,k)*dum1)
     +a2*(c(20,i+2,j,k)*dup2-c(20,i-2,j,k)*dum2));
  r2 = r2 +stry(j)*strx(i)*(a1*(c(23,i+1,j,k)*dup1-c(23,i-1,j,k)*dum1)
     +a2*(c(23,i+2,j,k)*dup2-c(23,i-2,j,k)*dum2));
  r3 = r3 +stry(j)*strx(i)*(a1*(c(26,i+1,j,k)*dup1-c(26,i-1,j,k)*dum1)
     +a2*(c(26,i+2,j,k)*dup2-c(26,i-2,j,k)*dum2));
  ...
  dum2 = a2*(u(3,i-2,j+2,k)-u(3,i-2,j-2,k))+
     a1*(u(3,i-2,j+1,k)-u(3,i-2,j-1,k));
  r1 = r1 +stry(j)*strx(i)*(a1*(c(21,i+1,j,k)*dup1-c(21,i-1,j,k)*dum1)
     +a2*(c(21,i+2,j,k)*dup2-c(21,i-2,j,k)*dum2));
  r2 = r2 +stry(j)*strx(i)*(a1*(c(24,i+1,j,k)*dup1-c(24,i-1,j,k)*dum1)
     +a2*(c(24,i+2,j,k)*dup2-c(24,i-2,j,k)*dum2));
  r3 = r3 +stry(j)*strx(i)*(a1*(c(27,i+1,j,k)*dup1-c(27,i-1,j,k)*dum1)
     +a2*(c(27,i+2,j,k)*dup2-c(27,i-2,j,k)*dum2));
  ...
  dum2 = a2*(u(1,i+2,j-2,k)-u(1,i-2,j-2,k))+
     a1*(u(1,i+1,j-2,k)-u(1,i-1,j-2,k));
  r1 = r1 +strx(i)*stry(j)*(a1*(c(19,i,j+1,k)*dup1-c(19,i,j-1,k)*dum1)
     +a2*(c(19,i,j+2,k)*dup2-c(19,i,j-2,k)*dum2));
  r2 = r2 +strx(i)*stry(j)*(a1*(c(20,i,j+1,k)*dup1-c(20,i,j-1,k)*dum1)
     +a2*(c(20,i,j+2,k)*dup2-c(20,i,j-2,k)*dum2));
  r3 = r3 +strx(i)*stry(j)*(a1*(c(21,i,j+1,k)*dup1-c(21,i,j-1,k)*dum1)
     +a2*(c(21,i,j+2,k)*dup2-c(21,i,j-2,k)*dum2));
  ...
  dum2 = a2*(u(2,i+2,j-2,k)-u(2,i-2,j-2,k))+
     a1*(u(2,i+1,j-2,k)-u(2,i-1,j-2,k));
  r1 = r1 +strx(i)*stry(j)*(a1*(c(22,i,j+1,k)*dup1-c(22,i,j-1,k)*dum1)
     +a2*(c(22,i,j+2,k)*dup2-c(22,i,j-2,k)*dum2));
  r2 = r2 +strx(i)*stry(j)*(a1*(c(23,i,j+1,k)*dup1-c(23,i,j-1,k)*dum1)
     +a2*(c(23,i,j+2,k)*dup2-c(23,i,j-2,k)*dum2));
  r3 = r3 +strx(i)*stry(j)*(a1*(c(24,i,j+1,k)*dup1-c(24,i,j-1,k)*dum1)
     +a2*(c(24,i,j+2,k)*dup2-c(24,i,j-2,k)*dum2));
  ...
  dum2 = a2*(u(3,i+2,j-2,k)-u(3,i-2,j-2,k))+
     a1*(u(3,i+1,j-2,k)-u(3,i-1,j-2,k));
  r1 = r1 +strx(i)*stry(j)*(a1*(c(25,i,j+1,k)*dup1-c(25,i,j-1,k)*dum1)
     +a2*(c(25,i,j+2,k)*dup2-c(25,i,j-2,k)*dum2));
  r2 = r2 +strx(i)*stry(j)*(a1*(c(26,i,j+1,k)*dup1-c(26,i,j-1,k)*dum1)
     +a2*(c(26,i,j+2,k)*dup2-c(26,i,j-2,k)*dum2));
  r3 = r3 +strx(i)*stry(j)*(a1*(c(27,i,j+1,k)*dup1-c(27,i,j-1,k)*dum1)
     +a2*(c(27,i,j+2,k)*dup2-c(27,i,j-2,k)*dum2));
...
#pragma omp simd
  ...
  dum2 = a2*(u(1,i-2,j,k+2)-u(1,i-2,j,k-2))+
     a1*(u(1,i-2,j,k+1)-u(1,i-2,j,k-1));
  r1 = r1 +strz(k)*strx(i)*(a1*(c(28,i+1,j,k)*dup1-c(28,i-1,j,k)*dum1)
     +a2*(c(28,i+2,j,k)*dup2-c(28,i-2,j,k)*dum2));
  r2 = r2 +strz(k)*strx(i)*(a1*(c(31,i+1,j,k)*dup1-c(31,i-1,j,k)*dum1)
     +a2*(c(31,i+2,j,k)*dup2-c(31,i-2,j,k)*dum2));
  r3 = r3 +strz(k)*strx(i)*(a1*(c(34,i+1,j,k)*dup1-c(34,i-1,j,k)*dum1)
     +a2*(c(34,i+2,j,k)*dup2-c(34,i-2,j,k)*dum2));
  ...
  dum2 = a2*(u(2,i-2,j,k+2)-u(2,i-2,j,k-2))+
     a1*(u(2,i-2,j,k+1)-u(2,i-2,j,k-1));
  r1 = r1 +strz(k)*strx(i)*(a1*(c(29,i+1,j,k)*dup1-c(29,i-1,j,k)*dum1)
     +a2*(c(29,i+2,j,k)*dup2-c(29,i-2,j,k)*dum2));
  r2 = r2 +strz(k)*strx(i)*(a1*(c(32,i+1,j,k)*dup1-c(32,i-1,j,k)*dum1)
     +a2*(c(32,i+2,j,k)*dup2-c(32,i-2,j,k)*dum2));
  r3 = r3 +strz(k)*strx(i)*(a1*(c(35,i+1,j,k)*dup1-c(35,i-1,j,k)*dum1)
     +a2*(c(35,i+2,j,k)*dup2-c(35,i-2,j,k)*dum2));
  ...
  dum2 = a2*(u(3,i-2,j,k+2)-u(3,i-2,j,k-2))+
     a1*(u(3,i-2,j,k+1)-u(3,i-2,j,k-1));
  r1 = r1 +strz(k)*strx(i)*(a1*(c(30,i+1,j,k)*dup1-c(30,i-1,j,k)*dum1)
     +a2*(c(30,i+2,j,k)*dup2-c(30,i-2,j,k)*dum2));
  r2 = r2 +strz(k)*strx(i)*(a1*(c(33,i+1,j,k)*dup1-c(33,i-1,j,k)*dum1)
     +a2*(c(33,i+2,j,k)*dup2-c(33,i-2,j,k)*dum2));
  r3 = r3 +strz(k)*strx(i)*(a1*(c(36,i+1,j,k)*dup1-c(36,i-1,j,k)*dum1)
     +a2*(c(36,i+2,j,k)*dup2-c(36,i-2,j,k)*dum2));
  ...
  dum2 = a2*(u(1,i+2,j,k-2)-u(1,i-2,j,k-2))+
     a1*(u(1,i+1,j,k-2)-u(1,i-1,j,k-2));
  r1 = r1 +strx(i)*strz(k)*(a1*(c(28,i,j,k+1)*dup1-c(28,i,j,k-1)*dum1)
     +a2*(c(28,i,j,k+2)*dup2-c(28,i,j,k-2)*dum2));
  r2 = r2 +strx(i)*strz(k)*(a1*(c(29,i,j,k+1)*dup1-c(29,i,j,k-1)*dum1)
     +a2*(c(29,i,j,k+2)*dup2-c(29,i,j,k-2)*dum2));
  r3 = r3 +strx(i)*strz(k)*(a1*(c(30,i,j,k+1)*dup1-c(30,i,j,k-1)*dum1)
     +a2*(c(30,i,j,k+2)*dup2-c(30,i,j,k-2)*dum2));
  ...
  dum2 = a2*(u(2,i+2,j,k-2)-u(2,i-2,j,k-2))+
     a1*(u(2,i+1,j,k-2)-u(2,i-1,j,k-2));
  r1 = r1 +strx(i)*strz(k)*(a1*(c(31,i,j,k+1)*dup1-c(31,i,j,k-1)*dum1)
     +a2*(c(31,i,j,k+2)*dup2-c(31,i,j,k-2)*dum2));
  r2 = r2 +strx(i)*strz(k)*(a1*(c(32,i,j,k+1)*dup1-c(32,i,j,k-1)*dum1)
     +a2*(c(32,i,j,k+2)*dup2-c(32,i,j,k-2)*dum2));
  r3 = r3 +strx(i)*strz(k)*(a1*(c(33,i,j,k+1)*dup1-c(33,i,j,k-1)*dum1)
     +a2*(c(33,i,j,k+2)*dup2-c(33,i,j,k-2)*dum2));
  ...
  dum2 = a2*(u(3,i+2,j,k-2)-u(3,i-2,j,k-2))+
     a1*(u(3,i+1,j,k-2)-u(3,i-1,j,k-2));
  r1 = r1 +strx(i)*strz(k)*(a1*(c(34,i,j,k+1)*dup1-c(34,i,j,k-1)*dum1)
     +a2*(c(34,i,j,k+2)*dup2-c(34,i,j,k-2)*dum2));
  r2 = r2 +strx(i)*strz(k)*(a1*(c(35,i,j,k+1)*dup1-c(35,i,j,k-1)*dum1)
     +a2*(c(35,i,j,k+2)*dup2-c(35,i,j,k-2)*dum2));
  r3 = r3 +strx(i)*strz(k)*(a1*(c(36,i,j,k+1)*dup1-c(36,i,j,k-1)*dum1)
     +a2*(c(36,i,j,k+2)*dup2-c(36,i,j,k-2)*dum2));
  ...
  dum2 = a2*(u(1,i,j-2,k+2)-u(1,i,j-2,k-2))+
     a1*(u(1,i,j-2,k+1)-u(1,i,j-2,k-1));
  r1 = r1 +strz(k)*stry(j)*(a1*(c(37,i,j+1,k)*dup1-c(37,i,j-1,k)*dum1)
     +a2*(c(37,i,j+2,k)*dup2-c(37,i,j-2,k)*dum2));
  r2 = r2 +strz(k)*stry(j)*(a1*(c(40,i,j+1,k)*dup1-c(40,i,j-1,k)*dum1)
     +a2*(c(40,i,j+2,k)*dup2-c(40,i,j-2,k)*dum2));
  r3 = r3 +strz(k)*stry(j)*(a1*(c(43,i,j+1,k)*dup1-c(43,i,j-1,k)*dum1)
     +a2*(c(43,i,j+2,k)*dup2-c(43,i,j-2,k)*dum2));
  ...
  dum2 = a2*(u(2,i,j-2,k+2)-u(2,i,j-2,k-2))+
     a1*(u(2,i,j-2,k+1)-u(2,i,j-2,k-1));
  r1 = r1 +strz(k)*stry(j)*(a1*(c(38,i,j+1,k)*dup1-c(38,i,j-1,k)*dum1)
     +a2*(c(38,i,j+2,k)*dup2-c(38,i,j-2,k)*dum2));
  r2 = r2 +strz(k)*stry(j)*(a1*(c(41,i,j+1,k)*dup1-c(41,i,j-1,k)*dum1)
     +a2*(c(41,i,j+2,k)*dup2-c(41,i,j-2,k)*dum2));
  r3 = r3 +strz(k)*stry(j)*(a1*(c(44,i,j+1,k)*dup1-c(44,i,j-1,k)*dum1)
     +a2*(c(44,i,j+2,k)*dup2-c(44,i,j-2,k)*dum2));
  ...
  dum2 = a2*(u(3,i,j-2,k+2)-u(3,i,j-2,k-2))+
     a1*(u(3,i,j-2,k+1)-u(3,i,j-2,k-1));
  r1 = r1 +strz(k)*stry(j)*(a1*(c(39,i,j+1,k)*dup1-c(39,i,j-1,k)*dum1)
     +a2*(c(39,i,j+2,k)*dup2-c(39,i,j-2,k)*dum2));
  r2 = r2 +strz(k)*stry(j)*(a1*(c(42,i,j+1,k)*dup1-c(42,i,j-1,k)*dum1)
     +a2*(c(42,i,j+2,k)*dup2-c(42,i,j-2,k)*dum2));
  r3 = r3 +strz(k)*stry(j)*(a1*(c(45,i,j+1,k)*dup1-c(45,i,j-1,k)*dum1)
     +a2*(c(45,i,j+2,k)*dup2-c(45,i,j-2,k)*dum2));
  ...
  dum2 = a2*(u(1,i,j+2,k-2)-u(1,i,j-2,k-2))+
     a1*(u(1,i,j+1,k-2)-u(1,i,j-1,k-2));
  r1 = r1 +stry(j)*strz(k)*(a1*(c(37,i,j,k+1)*dup1-c(37,i,j,k-1)*dum1)
     +a2*(c(37,i,j,k+2)*dup2-c(37,i,j,k-2)*dum2));
  r2 = r2 +stry(j)*strz(k)*(a1*(c(38,i,j,k+1)*dup1-c(38,i,j,k-1)*dum1)
     +a2*(c(38,i,j,k+2)*dup2-c(38,i,j,k-2)*dum2));
  r3 = r3 +stry(j)*strz(k)*(a1*(c(39,i,j,k+1)*dup1-c(39,i,j,k-1)*dum1)
     +a2*(c(39,i,j,k+2)*dup2-c(39,i,j,k-2)*dum2));
  ...
  dum2 = a2*(u(2,i,j+2,k-2)-u(2,i,j-2,k-2))+
     a1*(u(2,i,j+1,k-2)-u(2,i,j-1,k-2));
  r1 = r1 +stry(j)*strz(k)*(a1*(c(40,i,j,k+1)*dup1-c(40,i,j,k-1)*dum1)
     +a2*(c(40,i,j,k+2)*dup2-c(40,i,j,k-2)*dum2));
  r2 = r2 +stry(j)*strz(k)*(a1*(c(41,i,j,k+1)*dup1-c(41,i,j,k-1)*dum1)
     +a2*(c(41,i,j,k+2)*dup2-c(41,i,j,k-2)*dum2));
  r3 = r3 +stry(j)*strz(k)*(a1*(c(42,i,j,k+1)*dup1-c(42,i,j,k-1)*dum1)
     +a2*(c(42,i,j,k+2)*dup2-c(42,i,j,k-2)*dum2));
  ...
  dum2 = a2*(u(3,i,j+2,k-2)-u(3,i,j-2,k-2))+
     a1*(u(3,i,j+1,k-2)-u(3,i,j-1,k-2));
  r1 = r1 +stry(j)*strz(k)*(a1*(c(43,i,j,k+1)*dup1-c(43,i,j,k-1)*dum1)
     +a2*(c(43,i,j,k+2)*dup2-c(43,i,j,k-2)*dum2));
  r2 = r2 +stry(j)*strz(k)*(a1*(c(44,i,j,k+1)*dup1-c(44,i,j,k-1)*dum1)
     +a2*(c(44,i,j,k+2)*dup2-c(44,i,j,k-2)*dum2));
  r3 = r3 +stry(j)*strz(k)*(a1*(c(45,i,j,k+1)*dup1-c(45,i,j,k-1)*dum1)
     +a2*(c(45,i,j,k+2)*dup2-c(45,i,j,k-2)*dum2));
