...
//-----------------------------------------------------------------------
void GridGeneratorGaussianHill::generate_grid_and_met( EW *a_ew, int g,
...
//-----------------------------------------------------------------------
void GridGeneratorGaussianHill::generate_grid_and_met_new_gh( EW *a_ew, int g, Sarray& a_x,
...
//-----------------------------------------------------------------------
void GridGeneratorGaussianHill::generate_grid_and_met_old_gh( EW *a_ew, Sarray& a_x,
                                                  Sarray& a_y, Sarray& a_z,
                                                  Sarray& a_jac, Sarray& a_met )
{
