...
//-----------------------------------------------------------------------
void EW::tw_ani_stiff_ci( int ifirst, int ilast, int jfirst, int jlast, int kfirst, 
...
//-----------------------------------------------------------------------
void EW::tw_ani_curvi_stiff_ci( int ifirst, int ilast, int jfirst, int jlast, int kfirst, 
